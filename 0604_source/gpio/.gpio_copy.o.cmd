cmd_/home/root/gpio/gpio_copy.o := gcc -m64 -Wp,-MD,/home/root/gpio/.gpio_copy.o.d  -nostdinc -isystem /usr/lib64/gcc/powerpc64-fsl-linux/4.8.1/include -I/usr/src/linux/arch/powerpc/include -Iarch/powerpc/include/generated  -Iinclude -I/usr/src/linux/arch/powerpc/include/uapi -Iarch/powerpc/include/generated/uapi -I/usr/src/linux/include/uapi -Iinclude/generated/uapi -include /usr/src/linux/include/linux/kconfig.h -D__KERNEL__ -Iarch/powerpc -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -Werror-implicit-function-declaration -Wno-format-security -fno-delete-null-pointer-checks -O2 -msoft-float -pipe -Iarch/powerpc -mtraceback=no -mcall-aixdesc -mcmodel=medium -mno-pointers-to-nested-functions -mcpu=powerpc64 -mno-altivec -mno-vsx -mno-spe -mspe=no -funit-at-a-time -fno-dwarf2-cfi-asm -mno-string -Wa,-maltivec -Wframe-larger-than=1024 -fno-stack-protector -Wno-unused-but-set-variable -fomit-frame-pointer -g -Wdeclaration-after-statement -Wno-pointer-sign -fno-strict-overflow -fconserve-stack -DCC_HAVE_ASM_GOTO  -DMODULE -mcmodel=large  -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(gpio_copy)"  -D"KBUILD_MODNAME=KBUILD_STR(gpio_copy)" -c -o /home/root/gpio/.tmp_gpio_copy.o /home/root/gpio/gpio_copy.c

source_/home/root/gpio/gpio_copy.o := /home/root/gpio/gpio_copy.c

deps_/home/root/gpio/gpio_copy.o := \
...
/home/root/gpio/gpio_copy.o: $(deps_/home/root/gpio/gpio_copy.o)
