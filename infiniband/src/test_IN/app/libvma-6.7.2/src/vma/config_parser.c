  ...
  switch (yyn)
    {
        case 17:
/* Line 1787 of yacc.c  */
#line 376 "util/config_parser.y"
    { __vma_log_set_log_stderr(); }
    break;

  case 18:
/* Line 1787 of yacc.c  */
#line 377 "util/config_parser.y"
    { __vma_log_set_log_syslog(); }
    break;

  case 19:
/* Line 1787 of yacc.c  */
#line 378 "util/config_parser.y"
    { __vma_log_set_log_file((yyvsp[(3) - (3)].sval)); }
    break;

  case 20:
/* Line 1787 of yacc.c  */
#line 382 "util/config_parser.y"
    { __vma_log_set_min_level((yyvsp[(2) - (2)].ival)); }
    break;

  case 22:
/* Line 1787 of yacc.c  */
#line 390 "util/config_parser.y"
