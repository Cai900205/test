...
dnl 
dnl Generated by hpcuser at Wed Nov  5 17:03:36 2014
dnl on hpchead.
dnl ---------------------------------------------------------------------------
...
m4_define([mca_orte_rmaps_m4_config_component_list], [lama, mindist, rank_file])
...
m4_define([mca_orte_state_no_config_component_list], [app, hnp, novm, orted, staged_hnp, staged_orted, tool])
...
m4_define([mca_ompi_common_m4_config_component_list], [cuda, mx, sm, ugni, verbs])
...
m4_define([mca_ompi_coll_m4_config_component_list], [fca, hcoll, hierarch, ml, portals4])
...
m4_define([mca_ompi_mtl_m4_config_component_list], [mx, mxm, portals4, psm])
...
m4_define([mca_ompi_pml_m4_config_component_list], [bfo, crcpw, ob1, v, yalla])
