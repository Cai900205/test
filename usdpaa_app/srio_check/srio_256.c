...
#define PACKET_LENGTH 256	/*packet length*/
#define BUFFER_NUM 25600		/*buffer number*/
#define SEND_TOTAL_NUM 4	/*SEND_NUMber*/
/*ctx end*/
...
static void *t_srio_receive(void *arg)
{
	...
	uint32_t count=0,total_buf=4,buf_number=BUFFER_NUM;
	cpu_set_t cpuset;
