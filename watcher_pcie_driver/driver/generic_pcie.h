...
#define GENERIC_PCIE_VENDORID 0x1957
#define GENERIC_PCIE_DEVICEID 0x0440
...
struct generic_dev
{
    ...
    u64 dma_write_phyaddr;
    u64 dma_write_viraddr;
    u64 dma_read_phyaddr;
    u64 dma_read_viraddr;
    u64 dma_desc_phyaddr;
    u64 dma_desc_viraddr;
